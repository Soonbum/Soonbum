...
### Career
  ...
  * (주)하이콘소프트 : 2023.07 ~ 2024.04 (자동차 클러스터 시스템 미들웨어)

  * (주)스마트맥스 : 2020.07 ~ 2023.06 (건설 IT, BIM)

  * 경동이엔씨(주) : 2015.05 ~ 2020.05 (신재생에너지, 태양광 및 ESS)

  * (주)두올테크 : 2012.03 ~ 2015.03 (건설 IT, BIM)

  * 광운대학교 대학원 전자공학과 3D디스플레이연구센터(3DRC) 석사 졸업 : 2010 ~ 2011 (무안경 디스플레이, 영상처리)

  * 광운대학교 대학원 컴퓨터공학과 무선네트워크연구실 중퇴 : 2007 ~ 2008
...
### Participated projects
  ...
  * (주)카티스
    ...
    - 참여 프로젝트
      ...
      * 하수역학기반 마약류 검출 실증과제 (2026.05.15 ~ 2026.11.30)
