...
### Bio
  ...
  ![profile](https://user-images.githubusercontent.com/16474083/165702159-4b4ac09c-582a-4b9f-b961-e76de51c8bd3.jpg)
  ...
  * `C/C++` `Python` `GDL` `OpenCV` `MFC` `MATLAB`
...
### Participated projects
  ...
  * (주)두올테크
    ...
    - 아키캐드 GDL 라이브러리 개발
      ...
      * SK하이닉스 반도체 공장 라이브러리 (2014.12 ~ 2015.03): LOD 400(상세) 수준의 반도제 공장 라이브러리 개발
...
### Side projects
  ...
  * [성경 뷰어](http://peacemaker84.dothome.co.kr/BibleViewer/index.html)(JS+NodeJS+Express)
...
### Shared materials
  ...
  * [아키캐드 GDL 강의](https://blog.naver.com/PostList.nhn?blogId=canvas84&from=postList&categoryNo=61)

  * [아키캐드 GDL 레퍼런스 가이드](https://drive.google.com/file/d/0B5OVi05HUO7sOXJPSm95MnJGLXc/view?usp=sharing)
